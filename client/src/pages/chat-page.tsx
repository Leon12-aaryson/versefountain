...
export default function ChatPage() {
  ...
  const { connected, rooms, activeRoom, joinRoom, leaveRoom } = useChat();
        ...
        {!selectedRoomId ? (
          <div className="py-6 px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-2xl font-bold text-gray-800 mb-2">Chat Rooms</h1>
                <p className="text-gray-600">Connect with fellow readers and writers in real-time discussions</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {rooms.length === 0 ? (
                <div className="col-span-full flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-800">No chat rooms available</h3>
                  <p className="text-gray-500 mt-1">Be the first to create a room!</p>
                </div>
              ) : (
                rooms.map(room => (

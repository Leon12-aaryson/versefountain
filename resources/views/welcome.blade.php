                ...
                <div class="relative flex flex-col md:block">
                    ...
                    <div class="absolute inset-0 bg-black/60 md:bg-black/50 flex flex-col justify-end p-4 sm:p-6 md:p-8">
                        ...
                        <div class="flex flex-wrap gap-2 sm:gap-3">
                            <a href="/poetry"
                                class="bg-gray-800 hover:bg-gray-700 text-white text-xs sm:text-sm md:text-base py-2 px-4 sm:py-2.5 sm:px-5 md:py-3 md:px-6 font-normal transition-colors inline-flex items-center">
                                Explore Poetry
                            </a>
                            <a href="/books"

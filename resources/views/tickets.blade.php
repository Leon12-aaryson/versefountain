...
<head>
    ...
    <title>Tickets - {{ config('app.name', 'VerseFountain') }}</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="hidden md:block w-64 bg-white shadow-lg fixed h-full sidebar-scroll overflow-y-auto" style="top: 64px;">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="/tickets" class="flex items-center space-x-3 px-4 py-3 text-blue-600 bg-blue-50 rounded-lg font-medium">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 md:ml-64">
            <div class="py-6 px-4 sm:px-6 lg:px-8">
                <!-- Page Header -->
                <div class="mb-8">
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2">My Tickets</h1>
                    <p class="text-gray-600">Manage your event tickets and purchases</p>
                </div>

                <!-- Active Tickets -->
                <div class="mb-8">
                    <h2 class="text-xl font-semibold text-gray-900 mb-4">Active Tickets</h2>
                    <div class="space-y-4">
                        <div class="bg-white rounded-lg shadow-sm p-6">
                            <div class="flex justify-between items-start">
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Book Launch: "Whispers of the Heart"</h3>
                                    <p class="text-gray-600 mb-2">Dec 20, 2024 • 6:30 PM</p>
                                    <p class="text-gray-500 text-sm">Bookstore Cafe, Westside</p>
                                </div>
                                <div class="text-right">
                                    <span class="bg-green-100 text-green-800 text-xs px-3 py-1 rounded-full font-medium">Confirmed</span>
                                    <p class="text-sm text-gray-500 mt-2">Ticket #TK-2024-001</p>
                ...
                <!-- Purchase History -->
                <div class="mb-8">
                    <h2 class="text-xl font-semibold text-gray-900 mb-4">Purchase History</h2>
                    <div class="space-y-4">
                        <div class="bg-white rounded-lg shadow-sm p-6">
                            <div class="flex justify-between items-start">
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Poetry Workshop</h3>
                                    <p class="text-gray-600 mb-2">Nov 15, 2024 • 2:00 PM</p>
                                    <p class="text-gray-500 text-sm">Community Center</p>
                                </div>
                                <div class="text-right">
                                    <span class="bg-gray-100 text-gray-800 text-xs px-3 py-1 rounded-full font-medium">Completed</span>
                                    <p class="text-sm text-gray-500 mt-2">$25.00</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6">
                            <div class="flex justify-between items-start">
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Literary Festival</h3>
                                    <p class="text-gray-600 mb-2">Oct 28, 2024 • All Day</p>
                                    <p class="text-gray-500 text-sm">City Park</p>
                                </div>
                                <div class="text-right">
                                    <span class="bg-gray-100 text-gray-800 text-xs px-3 py-1 rounded-full font-medium">Completed</span>
                                    <p class="text-sm text-gray-500 mt-2">$40.00</p>
                                </div>
                            </div>
                        </div>
                    </div>

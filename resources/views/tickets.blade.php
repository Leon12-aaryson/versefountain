...
@section('content')
    <x-page-header title="Tickets" description="Purchase tickets for upcoming events and manage your bookings" />

    <x-search-filter placeholder="Search events or ticket types..." :filters="[
        ['options' => ['All Events', 'Poetry Reading', 'Book Launch', 'Workshop', 'Conference']],
        ['options' => ['All Status', 'Available', 'Sold Out', 'Upcoming']]
    ]" />

    <!-- Available Tickets -->
    <div class="mb-8">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">Available Tickets</h2>
    ...
    <!-- My Tickets -->
    <div class="mb-8">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">My Tickets</h2>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-green-600">Ticket #12345</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-2">
                        ...
                        <button class="bg-gray-600 text-white px-3 py-1 rounded text-xs font-medium hover:bg-gray-700 transition-colors">
                            Download
                        </button>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-green-600">Ticket #12346</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-2">
                        <button class="bg-blue-600 text-white px-3 py-1 rounded text-xs font-medium hover:bg-blue-700 transition-colors">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-green-600">Ticket #12347</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-2">
                        <button class="bg-blue-600 text-white px-3 py-1 rounded text-xs font-medium hover:bg-blue-700 transition-colors">
    ...
    <!-- Ticket Statistics -->
    <div class="mb-8">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">Ticket Statistics</h2>
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="text-center">
                    <div class="text-2xl font-bold text-purple-600 mb-2">$450</div>
                    <p class="text-gray-600">Total Spent</p>
                </div>
                <div class="text-center">
                    <div class="text-2xl font-bold text-red-600 mb-2">3</div>

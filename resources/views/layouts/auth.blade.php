...
<body class="antialiased bg-stone-50">
    <div class="min-h-screen bg-stone-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-5xl">
            <div class="bg-white border-2 border-gray-200 rounded-md py-8 px-4 sm:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="hidden md:flex flex-col justify-center">
                        ...
                        <div class="flex flex-col space-y-4">
                            <a href="/poetry">
                                <div class="flex items-center bg-white border-2 border-gray-200 rounded-md p-4 sm:p-6 hover:border-gray-300 focus-within:border-blue-600 transition-colors">
